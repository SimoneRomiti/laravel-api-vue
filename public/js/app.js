...
var app = new (vue_dist_vue__WEBPACK_IMPORTED_MODULE_1___default())({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://127.0.0.1:8000/api/quotes').then(function (response) {
  ...
  methods: {
    search: function search() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://127.0.0.1:8000/api/quotes/search/' + this.id).then(function (response) {
        _this2.array = [];
